...
public partial class Product_ProductAssignToJuridiction : System.Web.UI.Page
{
    ...
    private void DataList()
    {
        ...
        string query = " SELECT P.[Id],P.[Name],P.[StartDate],P.[EndDate],P.[IsActive],P.[Mrp] as MRP,P.[Offer] as Offer, " +
                       ...
                       " and P.Id not in (select ProductMasterId from Product where JurisdictionID = " + sJurisdictionId + ")" +
