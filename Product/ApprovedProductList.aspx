<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ApprovedProductList.aspx.cs" Inherits="Product_ApprovedProductList" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div style="width: 100%;" class="table-responsive">
                <asp:GridView ID="gvproductlist" OnRowDataBound="gvproductlist_RowDataBound" OnRowCommand="gvproductlist_RowCommand" runat="server" Width="95%" AutoGenerateColumns="False" class="table table-bordered table-hover" rules="all" role="grid" CellPadding="10" CellSpacing="5" AllowSorting="True" HeaderStyle-BackColor="#ede8e8" HeaderStyle-HorizontalAlign="Center" EnableViewState="False" Caption="<b><u>PRODUCT APPROVAL LIST</u></b>" CaptionAlign="Top">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Jurisdiction Id" DataField="JurisdictionId" />
