<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="AddMasterFranchisee.aspx.cs" Inherits="Franchisee_AddMasterFranchisee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content" style="">
            <div class="row">
                <a href="MasterFranchiseeList.aspx" class="btn btn-block btn-success pull-right" width="30%">Back To List</a>
            </div>
                ...
                <div class="tab-content table-responsive" style="padding-top: 20px">
                    <div role="tabpanel" class="tab-pane active">
                        ...
                        <div class="row pad-bottom">
                            <div class="col-md-12">
                                <div class="col-md-3 pad">
                                    <asp:Label ID="lblFranchiseeName" runat="server" Text="Master Franchisee Name"></asp:Label><span id="span1" runat="server" style="color: red">*</span>
                                </div>
                                <div class="col-md-7 pad">
                                    <asp:TextBox ID="txtMasterFranchiseeName" runat="server" CssClass="form-control" Width="40%" Placeholder="Master Franchisee Name"> </asp:TextBox>
                                </div>
                                <div class="col-md-2 pad">
                                    <span id="spnMasterFranchiseeName" style="color: #d9534f; display: none;">This field is required</span>
                                </div>
                            </div>
                        </div>
                ...
                $(document).ready(function () {
                    $("#ContentPlaceHolder1_txtCustomerCode").blur(function () {
                        $.ajax({
                            ...
                            url: "AddMasterFranchisee.aspx/CheckCustomerCode",
                    ...
                    $("#ContentPlaceHolder1_BtnSave").click(function () {
                        var flag = true;
                        var franchiseeNameval = $("#ContentPlaceHolder1_txtMasterFranchiseeName").val();
                        ...
                        if (franchiseeNameval == "") {
                            $("#spnMasterFranchiseeName").css('display', 'block');
                            flag = false;
                        }
                        if (contactNumberval == "") {
