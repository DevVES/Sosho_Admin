<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="SuperFranchiseeList.aspx.cs" Inherits="Franchisee_SuperFranchiseeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <a href="AddSuperFranchisee.aspx" class="btn btn-success pull-right add-padding" style="width: 80px">ADD</a>
            </div>
            <div class="row">
            ...
            <div style="width: 100%;" class="table-responsive">
                <asp:GridView ID="gvFranchiseelist" 
                    ...
                    HeaderStyle-HorizontalAlign="Center" Caption="<b><u>SUPER FRANCHISEE LIST</u></b>" CaptionAlign="Top">
                    <Columns>
                        <asp:BoundField HeaderText="Super Franchisee" DataField="SuperFranchiseeName" />
                        <asp:BoundField HeaderText="Contact Number" DataField="SuperFranchiseeContactNumber" />
                        <asp:BoundField HeaderText="EmailAddress" DataField="SuperFranchiseeEmailAddress" />
                        <asp:BoundField HeaderText="CustomerCode" DataField="SuperFranchiseeCustomerCode" />
                        <asp:BoundField HeaderText="ShortUrl" DataField="ShortUrl" />

                        <asp:HyperLinkField DataNavigateUrlFields="Id" ControlStyle-CssClass="red" HeaderText="EDIT" DataNavigateUrlFormatString="~/Franchisee/AddSuperFranchisee.aspx?Id={0}" Text="Edit" />
                    </Columns>
