<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="MasterFranchiseeList.aspx.cs" Inherits="Franchisee_MasterFranchiseeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <a href="AddMasterFranchisee.aspx" class="btn btn-success pull-right add-padding" style="width: 80px">ADD</a>
            </div>
            <div class="row">
            ...
            <div style="width: 100%;" class="table-responsive">
                <asp:GridView ID="gvFranchiseelist" 
                    ...
                    HeaderStyle-HorizontalAlign="Center" Caption="<b><u>MASTER FRANCHISEE LIST</u></b>" CaptionAlign="Top">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Contact Number" DataField="MasterFranchiseeContactNumber" />
                        <asp:BoundField HeaderText="EmailAddress" DataField="MasterFranchiseeEmailAddress" />
                        <asp:BoundField HeaderText="CustomerCode" DataField="MasterFranchiseeCustomerCode" />
                        <asp:BoundField HeaderText="ShortUrl" DataField="ShortUrl" />

                        <asp:HyperLinkField DataNavigateUrlFields="Id" ControlStyle-CssClass="red" HeaderText="EDIT" DataNavigateUrlFormatString="~/Franchisee/AddMasterFranchisee.aspx?Id={0}" Text="Edit" />
                    </Columns>
