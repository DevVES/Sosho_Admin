<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="WalletHistoryDashboard.aspx.cs" Inherits="Wallet_WalletHistoryDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>Wallet Transaction Dashboard
               <small>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                   ...
                   <div class="small-box bg-green">
                        <div class="inner">
                            <h3>
                                <asp:Literal ID="ltrCreatedTransaction" runat="server"></asp:Literal></h3>
                            <p>Created Transaction</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-yellow">
                        <div class="inner minheight103">
                            <h3>
                                <asp:Literal ID="ltrHasgoneCount" runat="server"></asp:Literal></h3>
                            <p>Has Gone Transaction</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        <div class="inner minheight103">
                            <h3>
                                <asp:Literal ID="ltrhascame" runat="server"></asp:Literal></h3>
                            <p>Has Came Transaction</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                 ...
                 <div class="small-box bg-blue">
                        <div class="inner minheight103">
                            <h3>
                                <asp:Literal ID="ltrissuccess" runat="server"></asp:Literal></h3>
                            <p>Is Success Transaction</p>
                        </div>
                        <div class="icon">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none">
                            <div class="box box-warning">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdGrn" AutoGenerateColumns="false" runat="server" AllowSorting="True" CssClass="table dataTable table-hover table-bordered table-responsive"  Width="100%">
