<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="AddDelivery.aspx.cs" Inherits="Delivery_AddDelivery" %>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <a href="Delivery.aspx" class="btn btn-block btn-success pull-right" style="width: 50%" target="_blank" title="Back To List">Back To List</a>
                    </div>
                </div>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="basic">
                        <div class="row pad-bottom">
                            <div class="col-md-12">
                                <div class="col-md-3 pad">
                                    <asp:Label ID="lblDeliveryIncharge" runat="server" Text="Delivery Incharge"></asp:Label><span style="color: red">*</span>
                                </div>
                                <div class="col-md-7 pad">
                                    <asp:TextBox ID="txtDeliveryIncharge" runat="server" CssClass="form-control" Width="40%" placeholder="Delivery Incharge"> </asp:TextBox>
                                </div>
                                <div class="col-md-2 pad">
                                    <span id="spnDeliveryIncharge" style="color: #d9534f; display: none;">This field is required</span>
                                </div>
                            </div>
                        </div>
                        <div class="row pad-bottom">
                        ...
                        <div class="row pad-bottom">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2 pad">
                                    <span id="spnArea" style="color: #d9534f; display: none;">Please check at least one checkbox</span>
                                </div>
                            </div>
                        </div>
                        <div class="row pad-bottom">
