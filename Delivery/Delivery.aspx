<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Delivery.aspx.cs" Inherits="Delivery_Delivery" %>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <a href="AddDelivery.aspx" class="btn btn-success pull-right add-padding" style="width: 50px; margin: 20px" target="_blank">Add</a>
                    </div>
                </div>
            </div>

            <div style="width: 100%;" class="table-responsive">
                <asp:GridView ID="gvDeliverylist" OnRowDataBound="gvDeliverylist_RowDataBound" runat="server" Width="95%" AutoGenerateColumns="False" class="table table-bordered table-hover" rules="all" role="grid" CellPadding="10" CellSpacing="5" AllowSorting="True" HeaderStyle-BackColor="#ede8e8" HeaderStyle-HorizontalAlign="Center" EnableViewState="False" Caption="<b><u>DELIVERY LIST</u></b>" CaptionAlign="Top">
                     <Columns>
                          <asp:BoundField HeaderText="Delivery Incharge" DataField="DeliveryIncharge" />
                        ...
                        <asp:BoundField HeaderText="Comments" DataField="Comments" />
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="DeliveryID" ControlStyle-CssClass="red" HeaderText="EDIT" Target="_blank" DataNavigateUrlFormatString="~/Delivery/AddDelivery.aspx?Id={0}" Text="Edit" />
             ...
             <script type="text/javascript">
                $(document).ready(function () {
                    $('#ContentPlaceHolder1_gvDeliverylist').DataTable({
                        "fixedHeader": true,
                        "paging": true,
                        "order": [[5, "desc"]],
                        "lengthChange": true,
